...
|---------------------|---------------|------------------|------------------------------------|
| empty heap          |          73.3 |         13643943 |                    42.2 ms |
| loaded heap (~1k)   |          60.8 |         16455672 |                    35.0 ms |

## VYHODNOCENÍ CAPU (S-02/D10a)

- Technický strop 8 h = 576,000 kroků. Při změřené ceně catch-up trvá ~42.2 ms (empty heap).
- Prahy:
...
- **ZÁVĚR**: POTVRDIT cap 8h ✓ (empty heap pod cílem 10,000 ns/krok; catch-up 42.2 ms << 5760 ms)
