...
|---------------------|---------------|------------------|------------------------------------|
| empty heap          |         375.1 |          2666263 |                   216.0 ms |
| loaded heap (~1k)   |         356.3 |          2806438 |                   205.2 ms |

## VYHODNOCENÍ CAPU (S-02/D10a)

- Technický strop 8 h = 576,000 kroků. Při změřené ceně catch-up trvá ~216.0 ms (empty heap).
- Prahy:
...
- **ZÁVĚR**: POTVRDIT cap 8h ✓ (prod. cesta pod cílem 1,500 ns/krok; catch-up 216.0 ms << 5760 ms)
