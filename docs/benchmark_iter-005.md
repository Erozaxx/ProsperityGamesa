...
|---------------------|---------------|------------------|------------------------------------|
| empty heap          |         432.5 |          2312333 |                   249.1 ms |
| loaded heap (~1k)   |         490.2 |          2040047 |                   282.3 ms |

## VYHODNOCENÍ CAPU (S-02/D10a)

- Technický strop 8 h = 576,000 kroků. Při změřené ceně catch-up trvá ~249.1 ms (empty heap).
- Prahy:
...
- **ZÁVĚR**: POTVRDIT cap 8h ✓ (prod. cesta pod cílem 1,500 ns/krok; catch-up 249.1 ms << 5760 ms)
