...
|---------------------|---------------|------------------|------------------------------------|
| empty heap          |         290.2 |          3446447 |                   167.1 ms |
| loaded heap (~1k)   |         282.4 |          3540503 |                   162.7 ms |

## VYHODNOCENÍ CAPU (S-02/D10a)

- Technický strop 8 h = 576,000 kroků. Při změřené ceně catch-up trvá ~167.1 ms (empty heap).
- Prahy:
...
- **ZÁVĚR**: POTVRDIT cap 8h ✓ (prod. cesta pod cílem 1,500 ns/krok; catch-up 167.1 ms << 5760 ms)
