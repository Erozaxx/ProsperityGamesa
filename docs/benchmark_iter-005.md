...
|---------------------|---------------|------------------|------------------------------------|
| empty heap          |        6305.0 |           158604 |                  3631.7 ms |
| loaded heap (~1k)   |        6257.7 |           159803 |                  3604.4 ms |

## VYHODNOCENÍ CAPU (S-02/D10a)

- Technický strop 8 h = 576,000 kroků. Při změřené ceně catch-up trvá ~3631.7 ms (empty heap).
- Prahy:
...
- **ZÁVĚR**: POTVRDIT cap 8h ✓ (empty heap pod cílem 10,000 ns/krok; catch-up 3631.7 ms << 5760 ms)
