...
- [ ] T-002a: architect – Revize designu: zapracovat B1 (registerBuild wired do bootstrapu), B2 (contract.offer re-arm se scheduleCountOf guardem v load/boot, mirror marketInit), M1 (rozhodnutí o SAVE_VERSION/migraci explicitně) + major/minor dle uvážení. Výstup: revidovaný design doc
- [ ] T-003: tom-proxy – Human gate: schválení revidovaného M5-2 designu (zastupuje uživatele dle DR-013-00, mandát: auto-ano u gate v rámci scope)
