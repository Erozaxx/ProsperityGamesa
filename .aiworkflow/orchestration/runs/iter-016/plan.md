...
- [ ] T-002a: architect – Revize designu: M-1 (day-index round-robin místo curStep%dist – zóny se reálně tikají na day-edge), M-2 (createWorldState init world.zones/factions; id-based merge zón na load; sdílená hydrateZones fn bez load-only větve – anti-DR-012-02; fresh-vs-load test), tribute split ujasnění (akumulace M7a-1 vs výběr M7a-2) + zúžit na M7a-1 scope (T1,T4,T5). Výstup: revidovaný design doc
- [ ] T-003: tom-proxy – Human gate: schválení revidovaného M7a-1 designu (mandát dle DR-013-00, auto-ano v rámci scope)
